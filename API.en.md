...
- [health](#health) - Health data (HealthKit)
...
| Name | Type | Description | Optional |
|------|------|-------------|----------|
| `types` | `string[]` | Permission type list ('stepCount', 'heartRate', 'sleepAnalysis', 'activeEnergyBurned', 'distanceWalkingRunning', 'bodyMass', 'height') | No |
...
| Name | Type | Description | Optional |
|------|------|-------------|----------|
| `type` | `string` | Permission type | No |
...
Get steps for specified date

**Parameters:**

| Name | Type | Description | Optional |
|------|------|-------------|----------|
| `startTimestamp` | `number` | Start timestamp | No |
| `endTimestamp` | `number` | End timestamp | No |
...
Get active energy burned today
...
Get walking/running distance today
